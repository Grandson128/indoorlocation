...
struct clientinfo parse_data(uint8_t *frame, uint16_t framelen, signed rssi, unsigned channel)
{
  ...
  mnth = month(t);
  yr = year(t);
  ci.date_time = String(yr) + "-" + String(mnth) + "-" + String(dy) + " " + String(hr) + "-" + String(min) + "-" + String(sec);
...
struct clientinfo parse_probe(uint8_t *frame, uint16_t framelen, signed rssi)
{
  ...
  mnth = month(t);
  yr = year(t);
  pi.date_time = String(yr) + "-" + String(mnth) + "-" + String(dy) + " " + String(hr) + "-" + String(min) + "-" + String(sec);
...
struct beaconinfo parse_beacon(uint8_t *frame, uint16_t framelen, signed rssi)
{
  ...
  mnth = month(t);
  yr = year(t);
  bi.date_time = String(yr) + "-" + String(mnth) + "-" + String(dy) + " " + String(hr) + "-" + String(min) + "-" + String(sec);
